...
unsigned int nStakeMinAge = 60 * 60 * 24 * 10;	// minimum age for coin age: 5d
unsigned int nStakeMaxAge = 60 * 60 * 24 * 30;	// stake age of full weight: 15d
unsigned int nStakeTargetSpacing = 60;			// 2-minute block spacing

int64 nChainStartTime = 1379132745;
int nCoinbaseMaturity = 57;
...
const string strMessageMagic = "Lucky7Coin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	int count7 = get7Counts(prevHash);
	...
	// Subsidy is cut in half every 259,200 blocks, which will occur approximately every month
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Lucky7Coin
    bool fStrictPayToScriptHash = true; // Always active in Lucky7Coin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Lucky7Coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Sep 13, 2013 5:30 AM PT: Producer Prices in U.S. Rose 0.3% in August on Energy, Food";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1379132785;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 11777711;
        ...
        assert(block.hashMerkleRoot == uint256("be231739dbe7b922e44d59563355ac773fcd8795ebc0034899c62be4149cb65c"));
...
unsigned char pchMessageStart[4] = { 0xcd, 0xf2, 0xdb, 0xc0 };
